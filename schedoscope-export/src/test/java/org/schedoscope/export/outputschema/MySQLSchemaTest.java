...
public class MySQLSchemaTest {
	...
	public void setUp() {
		...
		schema.setOutput("jdbc:mysql://localhost:3306/testing", "user", "pass", TABLE_NAME, null, NUM_PARTITIONS, COMMIT_SIZE, COLUMN_NAMES, COLUMN_TYPES);
	...
	public void testBuildCreateTableStatememt() {
		assertThat(schema.getCreateTableQuery(), allOf(
				...
				containsString("ENGINE"),
				containsString("InnoDB"),
