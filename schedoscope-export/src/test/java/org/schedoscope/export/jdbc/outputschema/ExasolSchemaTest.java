...
public class ExasolSchemaTest {
    ...
    public void setUp() {
        ...
        schema.setOutput("jdbc:exa:10.15.101.11..13:8563;schema=USR_TESTER_EXASOL", "user", "pass", TABLE_NAME, null,
                NUM_PARTITIONS, COMMIT_SIZE, null, null, COLUMN_NAMES, COLUMN_TYPES);
    }
    ...
    public void testBuildCreateTableStatememt() {
        assertThat(schema.getCreateTableQuery(), allOf(containsString("CREATE"), containsString(TABLE_NAME),
                containsString("username"), containsString("boolean"), containsString("pass"), containsString("int")));
    }
    ...
    public void testGetDistributedByClause() {
        schema = new ExasolSchema(conf);
        schema.setOutput("jdbc:exa:10.15.101.11..13:8563;schema=USR_TESTER_EXASOL", "user", "pass", TABLE_NAME, null,
                NUM_PARTITIONS, COMMIT_SIZE, null, "a,b", COLUMN_NAMES, COLUMN_TYPES);
