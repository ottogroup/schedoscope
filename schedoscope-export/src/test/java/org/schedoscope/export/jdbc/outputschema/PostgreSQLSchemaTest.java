...
public class PostgreSQLSchemaTest {
    ...
    private static final String[] COLUMN_NAMES = new String[]{"identifier",
            "userpass"};
    private static final String[] COLUMN_TYPES = new String[]{"real",
            "integer"};
    ...
    public void setUp() {
        ...
        schema.setOutput("jdbc:postgresql://localhost:5432/testing", "user",
                "pass", TABLE_NAME, null, NUM_PARTITIONS, COMMIT_SIZE, null,
    ...
    public void testBuildCreateTableStatememt() {
        assertThat(
                ...
                allOf(containsString("CREATE"), containsString(TABLE_NAME),
                        containsString("real"), containsString("integer"),
