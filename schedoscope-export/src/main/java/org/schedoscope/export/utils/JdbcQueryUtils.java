...
/**
 * A utility class to generate and execute various database related statements to drop, create tables and insert data
 * into them. Uses JDBC {@link java.sql.Connection Connection} and {@link java.sql.Statement Statement}.
 */
public class JdbcQueryUtils {
     ...
     */
    public static void dropTemporaryOutputTable(String table, Connection connection) {
     ...
     * @param connection The JDBC connection to use.
     */
    public static void dropTemporaryOutputTables(String table, int numberOfPartitions, Connection connection) {
     ...
     */
    public static void deleteExisitingRows(String table, String filter, Connection connection) {
    ...
    /**
     * Merges multiple temporary tables into the final output table, structure must be the same, uses "UNION ALL" for
     * merging.
     *
     ...
     * @param connection The JDBC connection object.
     */
    public static void mergeOutput(String table, String tablePrefix, int numberOfPartitions, Connection connection) {
     ...
     * @param connection The JDBC connection object.
     */
    public static void createTable(String createTableQuery, Connection connection) {
