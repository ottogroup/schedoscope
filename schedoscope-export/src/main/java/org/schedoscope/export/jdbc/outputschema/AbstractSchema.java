...
/**
 * This class provides a couple of functions common to all concrete Schema
 * implementations.
 */
public abstract class AbstractSchema implements Schema {
	...
	public void setOutput(String connectionString, String username,
			...
			String storageEngine, String distributeBy, String[] columnNames,
			String[] columnTypes) {
		...
		if (storageEngine != null) {
			...
			if (storageEngine.equals("MyISAM")
					|| storageEngine.equals("InnoDB")) {
				conf.set(Schema.JDBC_MYSQL_STORAGE_ENGINE, storageEngine);
			} else {
				LOG.warn("invalid storage engine: " + storageEngine
						+ " - default to InnoDB");
				conf.set(Schema.JDBC_MYSQL_STORAGE_ENGINE,
						MySQLSchema.JDBC_MYSQL_DEFAULT_STORAGE_ENGINE);
			}
		}
