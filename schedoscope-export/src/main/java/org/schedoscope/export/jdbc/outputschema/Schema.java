...
/**
 * A schema is a collection of functions and properties to write data into a
...
public interface Schema {
	...
	public void setOutput(String connectionString, String username,
			...
			String storageEngine, String distributedBy, String[] columnNames,
			String[] columnsTypes);
	...
	/**
	 * Returns the names of all columns that are used to build the SQL
	 * statements.
	 *
	...
	/**
	 * Returns the types of all columns that are used to build the SQL
	 * statement.
	 *
	...
	/**
	 * Returns the name mapping. The name mapping is used to use different
	...
	/**
	 * Returns the type mapping for the column data types. This map contains a
	 * mapping between data types of different database dialects.
	 *
	...
	/**
	 * Returns the type mapping for the prepared statement. This map contains a
	 * mapping between data types of different database dialects.
	 *
	 * @return The type map.
	 */
	...
	/**
	 * Returns the number of partitons, defines how many JDBC database writer
	...
	/**
	 * Returns the commit size, that is the number of records to insert within a
	 * single transaction.
	 *
