in = LOAD '${input_table}' USING org.apache.hive.hcatalog.pig.HCatLoader() AS (id:chararray, occurred_at:chararray, version:int, user_id:int, longitude:double, latitude:double, geohash:chararray, tags:map[], created_at:chararray, created_by:chararray, year:chararray, month:chararray);
