...
public class UserEntityServiceTest extends SpringTest {
  ...
  public void setupLocal() {
    ...
    doCallRealMethod().when(userEntityServiceMock).createUser(any(String.class), any(String.class), any(String.class),
        any(String.class), any(Boolean.class), any(String.class));
    doCallRealMethod().when(userEntityServiceMock).editUser(any(String.class), any(String.class), any(String.class),
        any(String.class), any(Boolean.class), any(String.class));
    doCallRealMethod().when(userEntityServiceMock).deleteUser(any(String.class));
    doCallRealMethod().when(userEntityServiceMock).setUserEntityRepository(any(UserEntityRepository.class));
  ...
  public void userService_01_createAdminUser() {
    ...
    userEntityServiceMock.createUser(TEST_ADMIN_USER, "admin@ottogroup.com", TEST_ADMIN_USER_FULLNAME, "admin", true,
        "OPS_USER");
  ...
  public void userService_02_createUser() {
    ...
    userEntityServiceMock.createUser(LOGGED_IN_USER, "test@ottogroup.com", LOGGED_IN_USER_FULLNAME, "test", false,
        "OPS_USER");
  ...
  public void userService_03_createUserToBeDeleted() {
    ...
    userEntityServiceMock.createUser("TO_BE_DELETED", "toDelete@ottogroup.com", "To Be Deleted", "test", false,
        "OPS_USER");
  ...
  public void userService_04_editUser() {
    UserEntity userEntity = userEntityRepository.findByUsername("TO_BE_DELETED");

    assertEquals(userEntity.getFullname(), "To Be Deleted");

    userEntityServiceMock.editUser("TO_BE_DELETED", "toDelete@ottogroup.com", "Edit Name", "test", false, "OPS_USER");
