...
public class ParameterValueEntityJdbcRepository implements
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ParameterValueEntityJdbcRepository.class);

    @Override
    public ParameterValueEntity get(Connection connection, ParameterValueEntityKey key) {
    ...
    @Override
    public void save(Connection connection, ParameterValueEntity parameterValueEntity) {
    ...
    @Override
    public void update(Connection connection, ParameterValueEntity parameterValueEntity) {
        String updateParameterSql = "update parameter_value_entity set "
                + JDBCUtil.getSetExpressionForClass(ParameterValueEntity.class) + " where " + ParameterValueEntity.URL_PATH
                + " = ? and " + ParameterValueEntity.KEY + " = ?";
        PreparedStatement stmt = null;
        try {
