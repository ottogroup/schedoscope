...
public class MySQLRepository implements RepositoryDAO {
	...
	public void insertOrUpdatePartial(Connection connection,
		...
		tableEntityMySQLRepository.insertOrUpdatePartial(connection,
				tableEntity);
	}
	...
	public void insertOrUpdate(Connection connection,
		...
		successorEntityMySQLRepository.insertOrUpdate(connection,
				successorEntity);
	}
	...
	public void insertOrUpdate(Connection connection,
		...
		parameterValueEntityMySQLRepository.insertOrUpdate(connection,
	...
	public void insertOrUpdate(Connection connection,
		...
		viewDependencyEntityMySQLRepository.insertOrUpdate(connection,
				dependency);
	}
	...
	public void insertOrUpdate(Connection connection,
		...
		tableDependencyEntityMySQLRepository.insertOrUpdate(connection,
				dependency);
	}
	...
	public void updateTableStatus(Connection connection,
			TableEntity tableEntity, Long lastTransformation) {
		tableEntityMySQLRepository.updateStatus(connection, tableEntity,
				lastTransformation);
	}
	...
	public void updateViewStatus(Connection connection, ViewEntity viewEntity,
			Long start, Long end) {
		viewEntityMySQLRepository.updateStatus(connection, viewEntity, start,
				end);
	}
