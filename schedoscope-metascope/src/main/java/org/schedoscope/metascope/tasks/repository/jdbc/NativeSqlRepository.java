...
public class NativeSqlRepository implements RepositoryDAO {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(NativeSqlRepository.class);
	...
	@Override
	public void updateTableStatus(Connection connection,
			TableEntity tableEntity, Long end) {
		tableEntityJdbcRepository.updateStatus(connection, tableEntity, end);
	}

	@Override
	public void updateViewStatus(Connection connection, ViewEntity viewEntity,
			Long start, Long end) {
		viewEntityJdbcRepository.updateStatus(connection, viewEntity, start,
				end);
	}

	@Override
	public void insertOrUpdatePartial(Connection connection,
			TableEntity tableEntity) {
		TableEntity t = tableEntityJdbcRepository.get(connection,
				tableEntity.getFqdn());
		if (t == null) {
	...
	public void insertOrUpdatePartial(Connection connection,
		...
		ViewEntity v = viewEntityJdbcRepository.get(connection,
				viewEntity.getUrlPath());
		if (v == null) {
	...
	public void insertOrUpdate(Connection connection,
		...
		SuccessorEntity s = successorEntityJdbcRepository.get(connection,
				successorEntity.getEntityKey());
		if (s == null) {
	...
	public void insertOrUpdate(Connection connection, FieldEntity fieldEntity) {
		FieldEntity f = fieldEntityJdbcRepository.get(connection,
				fieldEntity.getEntityKey());
		if (f == null) {
	...
	public void insertOrUpdate(Connection connection, TransformationEntity te) {
		TransformationEntity t = transformationEntityJdbcRepository.get(
				connection, te.getEntityKey());
		if (t == null) {
	...
	public void insertOrUpdate(Connection connection,
		...
		ParameterValueEntity p = parameterValueEntityJdbcRepository.get(
				connection, parameterValueEntity.getEntityKey());
		if (p == null) {
			parameterValueEntityJdbcRepository.save(connection,
					parameterValueEntity);
		} else {
			parameterValueEntityJdbcRepository.update(connection,
					parameterValueEntity);
		}
	}
	...
	@Override
	public void insertOrUpdate(Connection connection,
			ViewDependencyEntity dependency) {
		ViewDependencyEntity v = viewDependencyEntityJdbcRepository.get(
				connection, dependency.getEntityKey());
		if (v == null) {
	...
	public void insertOrUpdate(Connection connection,
		...
		TableDependencyEntity t = tableDependencyEntityJdbcRepository.get(
				connection, dependency.getEntityKey());
		if (t == null) {
	...
	public void insertOrUpdate(Connection connection, Metadata metadata) {
		Metadata m = metadataJdbcRepository.get(connection,
	...
	@Override
	public void insertOrUpdateTablesPartial(Connection connection,
	...
	@Override
	public void insertOrUpdateViewsPartial(Connection connection,
	...
	@Override
	public void insertOrUpdateFields(Connection connection,
	...
	@Override
	public void insertOrUpdateTransformations(Connection connection,
	...
	@Override
	public void insertOrUpdateParameterValues(Connection connection,
	...
	@Override
	public void insertOrUpdateViewDependencies(Connection connection,
	...
	@Override
	public void insertOrUpdateSuccessors(Connection connection,
	...
	@Override
	public void insertOrUpdateTableDependencies(Connection connection,
	...
	@Override
	public void insertOrUpdateExportPartial(Connection connection,
	...
	public void updateTableStatus(Connection connection, Set<TableEntity> tables) {
		for (TableEntity tableEntity : tables) {
			updateTableStatus(connection, tableEntity,
					tableEntity.getLastTransformation());
		}
	}
	...
	public void updateViewStatus(Connection connection, Set<ViewEntity> views) {
		for (ViewEntity viewEntity : views) {
			updateViewStatus(connection, viewEntity,
					viewEntity.getTransformationStart(),
					viewEntity.getTransformationEnd());
		}
	}
