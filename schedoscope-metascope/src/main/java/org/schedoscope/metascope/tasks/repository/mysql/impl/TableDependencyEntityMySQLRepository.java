...
public class TableDependencyEntityMySQLRepository implements
		MySQLRepository<TableDependencyEntity> {

	private static final Logger LOG = LoggerFactory
			.getLogger(TableDependencyEntityMySQLRepository.class);
	...
	public void insertOrUpdate(Connection connection,
		...
		String insertDependencySql = "insert into table_dependency_entity ("
				...
				+ MySQLUtil
						.getOnDuplicateKeyString(TableDependencyEntity.class);
