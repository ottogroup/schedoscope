...
public class TableEntity extends Documentable {
	...
	public void setTransformationProperties(
			List<TransformationEntity> transformationProperties) {
	...
	public List<String> getTaxonomyNames() {
		...
		if (cos != null) {
			for (CategoryObjectEntity categoryObjectEntity : cos) {
				TaxonomyEntity taxonomy = categoryObjectEntity.getCategory()
						.getTaxonomy();
	...
	public List<String> getCategoryNames() {
		...
		if (cos != null) {
			for (CategoryObjectEntity categoryObjectEntity : cos) {
				String categoryName = categoryObjectEntity.getCategory()
						.getName();
