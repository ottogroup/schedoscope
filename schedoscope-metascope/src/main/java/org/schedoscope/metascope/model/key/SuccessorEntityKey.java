...
public class SuccessorEntityKey implements Serializable {
    ...
    public SuccessorEntityKey(String urlPath, String successorUrlPath, String successorFqdn) {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((successorFqdn == null) ? 0 : successorFqdn.hashCode());
        result = prime * result + ((successorUrlPath == null) ? 0 : successorUrlPath.hashCode());
