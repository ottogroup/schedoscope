...
public class DocumentationController {
  ...
  public String updateDocumentation(HttpServletRequest request, RedirectAttributes redirAttr, String fqdn, String documentation) {
  ...
  public String editComment(HttpServletRequest request, RedirectAttributes redirAttr, String commentID, String commentText) {
  ...
  public String updateDocumentation(HttpServletRequest request, RedirectAttributes redirAttr, String fqdn, String fieldname, boolean parameter,
  ...
  public String addComment(HttpServletRequest request, String fqdn, RedirectAttributes redirAttr, String fieldname, boolean parameter, String comment) {
    FieldEntity fieldEntity = fieldEntityService.findByFqdnAndName(fqdn, fieldname);
  ...
  public String editFieldComment(HttpServletRequest request, RedirectAttributes redirAttr, String fieldname, boolean parameter, String commentID, String commentText) {
    CommentEntity commentEntity = documentationService.findById(commentID);
    documentationService.editComment(commentEntity, commentText, userEntityService.getUser());
    redirAttr.addFlashAttribute("comment", "edited");
    return getReferer(request, fieldname, parameter);
  ...
  public String deleteComment(HttpServletRequest request, RedirectAttributes redirAttr, String fieldname, boolean parameter, String commentID) {
    CommentEntity commentEntity = documentationService.findById(commentID);
