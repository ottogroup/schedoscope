...
import org.schedoscope.metascope.repository.*;
import org.schedoscope.metascope.repository.spec.ParameterValueSpec;
import org.schedoscope.metascope.util.*;
        ...
        if (parameterMap != null) {
            for (Entry<String, String[]> e : parameterMap.entrySet()) {
                ...
                for (String categoryObjectId : categoryObjects) {
                    ...
                    CategoryObjectEntity categoryObjectEntity = categoryObjectEntityRepository.findOne(Long
