...
public class SolrQueryResult {
	...
	public SolrQueryResult withResultEntities(
			List<SolrQueryResultEntity> resultEntities) {
	...
	public SolrQueryResult withFacetValues(
			Map<String, List<SolrFacet>> facetValues) {
	...
	public SolrQueryResult withActiveFilterValues(
			Map<String, List<String>> activeFilterValues) {
