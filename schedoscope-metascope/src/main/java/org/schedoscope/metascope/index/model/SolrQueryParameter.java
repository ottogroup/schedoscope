...
public class SolrQueryParameter {
	...
	public SolrQueryParameter(String displayName, String name,
			FilterType filterType) {
		this(displayName, name, false, filterType, FacetSort.INDEX);
	}

	public SolrQueryParameter(String displayName, String name,
			FilterType filterType, FacetSort facetSort) {
		this(displayName, name, false, filterType, facetSort);
	}

	public SolrQueryParameter(String displayName, String name,
			boolean excludeFromFacet, FilterType filterType, FacetSort facetSort) {
